...
def align(in_folder, out_folder, acoustic_model="english_us_arpa", dictionary_model="english_us_arpa"):
    ...
    subprocess.call(f"mfa model download acoustic {acoustic_model}", shell=True)
    
    subprocess.call(f"mfa model download dictionary {dictionary_model}", shell=True)
    
    subprocess.call(f"mfa align --clean {in_folder} {acoustic_model} {dictionary_model} {out_folder}", shell=True)
